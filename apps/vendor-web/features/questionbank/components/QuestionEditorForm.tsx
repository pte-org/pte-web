...
const TASK_TYPES: PteTaskType[] = [
  ...
  "FILL_IN_THE_BLANKS_DRAG_AND_DROP", "FILL_IN_THE_BLANKS_DROPDOWN", "SUMMARIZE_SPOKEN_TEXT",
  "MC_LISTENING_SINGLE", "MC_LISTENING_MULTIPLE", "FILL_IN_THE_BLANKS_TYPE_IN",
...
const OPTION_TASKS = new Set([
  "MC_READING_SINGLE", "MC_READING_MULTIPLE", "RE_ORDER_PARAGRAPHS",
  "FILL_IN_THE_BLANKS_DRAG_AND_DROP", "FILL_IN_THE_BLANKS_DROPDOWN", "MC_LISTENING_SINGLE",
...
const PROMPT_TASKS = new Set([
  ...
  "MC_READING_SINGLE", "MC_READING_MULTIPLE", "FILL_IN_THE_BLANKS_DRAG_AND_DROP",
  "FILL_IN_THE_BLANKS_DROPDOWN", "FILL_IN_THE_BLANKS_TYPE_IN", "HIGHLIGHT_INCORRECT_WORDS",
]);
const WORD_COUNT_TASKS = new Set(["SUMMARIZE_WRITTEN_TEXT", "WRITE_ESSAY", "SUMMARIZE_SPOKEN_TEXT"]);
const CORRECT_TEXT_TASKS = new Set([
  "ANSWER_SHORT_QUESTION", "FILL_IN_THE_BLANKS_TYPE_IN", "HIGHLIGHT_INCORRECT_WORDS", "WRITE_FROM_DICTATION",
]);
