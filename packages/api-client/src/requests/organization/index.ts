...
export const ORGANIZATION_ENDPOINTS = {
  organizations: (tenantPublicId: string) => `/api/tenants/${tenantPublicId}/organizations`,
  organization: (tenantPublicId: string, publicId: string) =>
    `/api/tenants/${tenantPublicId}/organizations/${publicId}`,
  suspend: (tenantPublicId: string, publicId: string) =>
    `/api/tenants/${tenantPublicId}/organizations/${publicId}/suspend`,
  reactivate: (tenantPublicId: string, publicId: string) =>
    `/api/tenants/${tenantPublicId}/organizations/${publicId}/reactivate`,
} as const;
